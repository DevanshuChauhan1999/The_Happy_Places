package com.devanshu.thehappyplaces.database
...
class DatabaseHandler(context: Context) :
     ...
     */
    fun addHappyPlace(happyPlace: HapplyPlaceModel): Long {
    ...
    fun getHappyPlacesList(): ArrayList<HapplyPlaceModel> {
        ...
        val happyPlaceList: ArrayList<HapplyPlaceModel> = ArrayList()
